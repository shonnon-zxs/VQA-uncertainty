...
class VQAFeatureDataset(Dataset):
            ...
            for entry in tqdm(self.entries, ncols=100, desc="caching-features"):
                ...
                if img_id not in image_to_fe:
                    if use_hdf5:
                        ...
                        fe=torch.load('/data/zxs/VQA/Methods/CSS-VQA-master/data/rcnn_feature2/'+str(img_id)+'.pth', encoding='latin1')['image_feature']
    ...
    def __getitem__(self, index):
        ...
        if self.image_to_fe is not None:
            ...
            features = torch.load('/data/zxs/VQA/Methods/CSS-VQA-master/data/rcnn_feature2/' + str(entry["image_id"]) + '.pth', encoding='latin1')['image_feature']
